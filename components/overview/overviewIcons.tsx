...
export function IconCalendar({ className = "shrink-0" }: { className?: string }): ReactElement {
  return (
    <DecorativeSvg className={className} width="18" height="18" viewBox="0 0 24 24" fill="none">
      <path
...
export function IconBolt({ className = "shrink-0" }: { className?: string }): ReactElement {
  return (
    <DecorativeSvg className={className} width="17" height="17" viewBox="0 0 24 24" fill="none">
...
export function IconPlay({ className = "text-white" }: { className?: string }): ReactElement {
  return (
    <DecorativeSvg className={className} width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
...
export function IconSkipForward({ className = "shrink-0" }: { className?: string }): ReactElement {
  return (
    <DecorativeSvg className={className} width="16" height="16" viewBox="0 0 24 24" fill="none">
      <path
...
export function IconClipboard({ className = "shrink-0" }: { className?: string }): ReactElement {
  return (
    <DecorativeSvg className={className} width="15" height="15" viewBox="0 0 24 24" fill="none">
      <path
...
export function IconUserPlus({ className = "shrink-0" }: { className?: string }): ReactElement {
  return (
    <DecorativeSvg className={className} width="20" height="20" viewBox="0 0 24 24" fill="none">
      <path
...
export function IconChipBalance({ className = "shrink-0" }: { className?: string }): ReactElement {
  return (
    <DecorativeSvg className={className} width="14" height="14" viewBox="0 0 24 24" fill="none">
      <path
        d="M20 6 9 17l-5-5"
        stroke="currentColor"
        strokeWidth="2"
